...
CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "accounts_hint": "The name shown in the tray, the tabs and the report. Changing an id moves its history, so that one stays in: cc-cockpit accounts --rename",
        ...
        "login_expires": "Login expires in {d}",
        "login_expired": "Login expired — run claude to sign in again",
        "card_official": "Official limits over time",
        "card_heatmap": "When the spending happens",
        "no_official_yet": "No official samples yet — they arrive while a CLI renders its statusline",
        "vs_yesterday": "{v} vs yesterday",
        "same_as_yesterday": "same as yesterday",
        "scope_today": "today",
        "scope_all": "all time",
        "heatmap_weeks": "last {n} weeks",
        "acct_searched": "Looked in:",
        "acct_add_hint": "Not there? Add it by hand:\n    cc-cockpit accounts --add work=/path/to/its/claude/dir",
        "acct_detect": "Detect",
        "acct_add": "Add directory…",
        "acct_remove": "Remove",
        "acct_pick": "Pick the Claude Code directory of the other account",
        "acct_found_unlisted": "Found {n} Claude Code director(ies) that are not set up as accounts:",
        "acct_detect_hint": "“Detect” below adds them.",
        "readings": "{n} readings",
        ...
        "no_recent": "No conversation to resume",
        "untitled": "(untitled)",
        "ago": "{d} ago",
        "copy_resume": "Copy the command that resumes it",
        "copied": "Copied",
        "recent_count": "Recent sessions offered",
        ...
        "cli_recent": "recent sessions · resume with the command below",
        "cli_none": "(none)",
    ...
    "pt": {
        ...
        "accounts_hint": "O nome que aparece na bandeja, nas abas e no relatório. Mudar um id move o histórico, então esse continua em: cc-cockpit accounts --rename",
        ...
        "login_expires": "Login expira em {d}",
        "login_expired": "Login expirado — rode claude para entrar de novo",
        "card_official": "Limites oficiais ao longo do tempo",
        "card_heatmap": "Quando o consumo acontece",
        "no_official_yet": "Ainda sem amostras oficiais — elas chegam quando um CLI renderiza a statusline",
        "vs_yesterday": "{v} vs ontem",
        "same_as_yesterday": "igual a ontem",
        "scope_today": "hoje",
        "scope_all": "histórico",
        "heatmap_weeks": "últimas {n} semanas",
        "acct_searched": "Procurei em:",
        "acct_add_hint": "Não está aí? Adicione à mão:\n    cc-cockpit accounts --add trabalho=/caminho/do/diretorio/claude",
        "acct_detect": "Detectar",
        "acct_add": "Adicionar diretório…",
        "acct_remove": "Remover",
        "acct_pick": "Escolha o diretório do Claude Code da outra conta",
        "acct_found_unlisted": "{n} diretório(s) do Claude Code encontrados que não estão configurados como conta:",
        "acct_detect_hint": "O botão “Detectar” abaixo adiciona.",
        "readings": "{n} leituras",
        ...
        "recent_sessions": "Últimas sessões",
        "no_recent": "Nenhuma conversa para retomar",
        "untitled": "(sem título)",
        "ago": "há {d}",
        "copy_resume": "Copiar o comando que retoma a sessão",
        "copied": "Copiado",
        "recent_count": "Últimas sessões oferecidas",
        ...
        "cli_recent": "últimas sessões · retome com o comando abaixo",
        "cli_none": "(nenhuma)",
    ...
    "es": {
        ...
        "accounts_hint": "El nombre que aparece en la bandeja, las pestañas y el informe. Cambiar un id mueve su historial, así que eso sigue en: cc-cockpit accounts --rename",
        ...
        "login_expires": "La sesión expira en {d}",
        "login_expired": "Sesión expirada — ejecuta claude para entrar de nuevo",
        "card_official": "Límites oficiales en el tiempo",
        "card_heatmap": "Cuándo ocurre el consumo",
        "no_official_yet": "Aún sin muestras oficiales — llegan cuando un CLI renderiza su statusline",
        "vs_yesterday": "{v} vs ayer",
        "same_as_yesterday": "igual que ayer",
        "scope_today": "hoy",
        "scope_all": "histórico",
        "heatmap_weeks": "últimas {n} semanas",
        "acct_searched": "Busqué en:",
        "acct_add_hint": "¿No está? Añádelo a mano:\n    cc-cockpit accounts --add trabajo=/ruta/del/directorio/claude",
        "acct_detect": "Detectar",
        "acct_add": "Añadir directorio…",
        "acct_remove": "Quitar",
        "acct_pick": "Elige el directorio de Claude Code de la otra cuenta",
        "acct_found_unlisted": "{n} directorio(s) de Claude Code que no están configurados como cuenta:",
        "acct_detect_hint": "El botón “Detectar” de abajo los añade.",
        "readings": "{n} lecturas",
        ...
        "no_recent": "Ninguna conversación para retomar",
        "untitled": "(sin título)",
        "ago": "hace {d}",
        "copy_resume": "Copiar el comando que la retoma",
        "copied": "Copiado",
        "recent_count": "Sesiones recientes ofrecidas",
        ...
        "cli_recent": "sesiones recientes · retoma con el comando de abajo",
        "cli_none": "(ninguna)",
